...
public class HomePage {
    ...
    private By bookButton = By.id("submitBooking");
   ...
   public void clickBookNow() {
    ...
    public boolean isBookingFormDisplayed() {
        ...
        WebElement button = driver.findElement(bookButton);
        return name.isDisplayed() && email.isDisplayed() && phone.isDisplayed() && button.isDisplayed();
    }
}
